...
<a href="<?php echo e(url('/kategori_lembur/create')); ?>"class="btn btn-success">Tambah Data</a>
	...
	<tbody>
		...
		<tr>
			<td><?php echo e($no++); ?></td>
			<td><?php echo e($kategori_lemburs->kode_lembur_id); ?></td>
			<td><?php echo e($kategori_lemburs->jabatanModel->jabatan_id); ?></td>
			<td><?php echo e($kategori_lemburs->golonganModel->golongan_id); ?></td>
